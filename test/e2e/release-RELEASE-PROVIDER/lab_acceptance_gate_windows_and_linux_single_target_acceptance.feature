...
Feature: Windows and Linux single-target acceptance matrix (DESIGN §18)
  ...
  winsw service wrapper, and runs each real WSV/NET/NOD service pattern through the
  provider engine.Deploy so their non-privileged stages (fetch/checksum/extract/
